    ...
    <aside class="alpenia-public-support-fab" aria-label="<?php echo esc_attr(alpenia_travel_t('Hilfe & Kontakt')); ?>">
        ...
        <div class="alpenia-public-support-fab__actions">
            <?php if ($support_whatsapp !== '') : ?>
                <a href="<?php echo esc_url($support_whatsapp); ?>" target="_blank" rel="noopener noreferrer">WhatsApp</a>
            <?php endif; ?>
            <?php if ($support_email !== '') : ?>
                <a href="mailto:<?php echo esc_attr($support_email); ?>">E-Mail</a>
            <?php endif; ?>
        </div>
    </aside>
    <?php
...
function alpenia_public_participant_create($trip_id, $values) {
    ...
    alpenia_send_notification('Neue Teilnehmerdaten übermittelt', 'Ein Teilnehmer hat öffentliche Formulardaten gesendet: ' . $title, [
        'event_label' => 'Öffentliche Teilnehmeranmeldung',
